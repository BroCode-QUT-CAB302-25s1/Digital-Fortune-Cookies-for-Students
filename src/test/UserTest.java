...
public class UserTest {
    ...
    @BeforeEach
    public void setup() {
        user = new User (USERNAME_ONE,PREFERRED_ONE ,FIRST_NAME_ONE, LAST_NAME_ONE, EMAIL_ONE,GITHUB_ONE, PHONE_ONE,LOCATION_ONE, JOB_ONE, GENDER_ONE, DOB_ONE, PASSWORD_ONE);
