...
public class SqliteUserDAO implements IUserDAO {
    ...
    private static final String UPDATE_USER = "UPDATE users SET preferred_name = ?, first_name = ?, last_name = ?, email = ?, github = ?, phone = ?, location = ?, job = ?, gender = ?, dob = ?, password = ? WHERE username = ?";
    ...
    public void updateUser(User user) {
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_USER)) {
            statement.setString(1, user.getPreferredName());
